...
IF(@sDanhMuc = 'GET_WORDORDER_DETAILS')
	BEGIN
		SELECT DISTINCT A.MS_PHIEU_BAO_TRI,A.MS_BO_PHAN,C.TEN_BO_PHAN,A.MS_CV,D.MO_TA_CV,B.MS_PT,E.TEN_PT,F.MS_VI_TRI_PT,B.SL_TT ,CTTBCV.PATH_HD
		...
		INNER JOIN dbo.CAU_TRUC_THIET_BI_CONG_VIEC CTTBCV ON CTTBCV.MS_MAY = C.MS_MAY AND CTTBCV.MS_BO_PHAN = C.MS_BO_PHAN
